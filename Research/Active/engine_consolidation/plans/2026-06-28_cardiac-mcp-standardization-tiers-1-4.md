...
- [~] Phase 4 (optional): **SKIPPED 2026-06-28** — user opted out of registry publishing (the server is fully usable locally + documented). `server.json`/LICENSE/Dockerfile deferred to a future publish decision.
...
**MUTATED 2026-06-28**: Phase 4 (Steps 4.1, 4.2) SKIPPED — user opted out of registry publishing. The server is fully usable locally + documented (README, REMOTE_DEPLOY); publishing artifacts deferred. Tiers 1–3 are the shipped scope.
