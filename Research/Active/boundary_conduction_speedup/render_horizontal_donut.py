"""Render the horizontal_donut variant video for visual comparison."""
...
DATA = ROOT / "data" / "case_horiz_donut_lbm_d2q9_canonical_horizontal_donut_natural.h5"
OUT = ROOT / "figures" / "video_bc_horizontal_donut.mp4"
