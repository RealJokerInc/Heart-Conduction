...
- [x] Monodomain control confirms no speedup
...
| `Monodomain/LBM_V1/src/collision/bgk.py` | LBM collision with source term |
| `Monodomain/LBM_V1/PROGRESS.md` | LBM engine status |
