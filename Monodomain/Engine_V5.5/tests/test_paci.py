"""
Tests for Paci 2013 hiPSC-CM Ionic Model
...
class TestPaciParameters:
    """P1: StateIndex, PaciParameters, get_initial_state()."""

    def test_n_states(self):
        """P1-V1: N_STATES == 17."""
        from cardiac_sim.ionic.paci.parameters import StateIndex
        assert StateIndex.N_STATES == 17

    def test_parameters_instantiate(self):
        """P1-V2: PaciParameters dataclass instantiates."""
        from cardiac_sim.ionic.paci.parameters import PaciParameters
        p = PaciParameters()
    ...
    def test_initial_state_shape(self):
        ...
        from cardiac_sim.ionic.paci.parameters import StateIndex, get_initial_state
    ...
    def test_v_rest(self):
        ...
        from cardiac_sim.ionic.paci.parameters import V_REST
        assert V_REST == pytest.approx(-74.334, abs=0.01)

    def test_ki_fixed(self):
        """P1-V5: Ki is fixed at 150 mM, not in state vector."""
        from cardiac_sim.ionic.paci.parameters import (
            StateIndex, PaciParameters, STATE_NAMES
        )
        p = PaciParameters()
        assert p.Ki == 150.0
...
class TestPaciGating:
    ...
    def test_inf_range(self, V_range):
        ...
        from cardiac_sim.ionic.paci.gating import (
    ...
    def test_m_inf_at_rest(self):
        ...
        from cardiac_sim.ionic.paci.gating import INa_m_inf
    ...
    def test_h_inf_at_rest(self):
        ...
        from cardiac_sim.ionic.paci.gating import INa_h_inf
        V = torch.tensor(-74.334, dtype=torch.float64)
    ...
    def test_xf_inf_at_rest(self):
        ...
        from cardiac_sim.ionic.paci.gating import If_Xf_inf
        V = torch.tensor(-74.334, dtype=torch.float64)
    ...
    def test_h_j_biphasic_smooth(self, V_range):
        ...
        from cardiac_sim.ionic.paci.gating import INa_h_tau, INa_j_tau
    ...
    def test_batched(self):
        ...
        from cardiac_sim.ionic.paci.gating import INa_m_inf, INa_m_tau
...
class TestPaciCurrents:
    """P3: Ion current functions."""

    @pytest.fixture
    def rest_state(self):
        """Return (V, state_dict) at initial conditions."""
        from cardiac_sim.ionic.paci.parameters import get_initial_state, StateIndex, V_REST
        state = get_initial_state(device=torch.device('cpu'))
    ...
    def test_INa_inward_at_depolarized(self):
        ...
        from cardiac_sim.ionic.paci.currents import I_Na
    ...
    def test_ICaL_no_nan_at_v0(self):
        ...
        from cardiac_sim.ionic.paci.currents import I_CaL
    ...
    def test_If_direction(self):
        ...
        from cardiac_sim.ionic.paci.currents import I_f
    ...
    def test_IK1_rectification(self):
        ...
        from cardiac_sim.ionic.paci.currents import I_K1
    ...
    def test_sum_at_rest(self, rest_state):
        ...
        from cardiac_sim.ionic.paci.currents import (
...
class TestPaciCalcium:
    ...
    def test_irel_triggered_by_d(self):
        ...
        from cardiac_sim.ionic.paci.calcium import i_rel
    ...
    def test_grel_frozen_at_depolarized(self):
        ...
        from cardiac_sim.ionic.paci.calcium import update_g_rel
    ...
    def test_buffering_in_01(self):
        ...
        from cardiac_sim.ionic.paci.calcium import buffering_factor_cyt, buffering_factor_sr
        Cai = torch.tensor(1e-5, dtype=torch.float64)
        CaSR = torch.tensor(0.3, dtype=torch.float64)
    ...
    def test_steady_state_cai(self):
        ...
        from cardiac_sim.ionic.paci.calcium import update_concentrations
        from cardiac_sim.ionic.paci.parameters import get_initial_state, StateIndex, V_REST
        state = get_initial_state(device=torch.device('cpu'))
        V = torch.tensor(V_REST, dtype=torch.float64)
        dt = 0.01
...
class TestPaciModel:
    """P5: PaciModel(IonicModel) integration."""

    def test_instantiation(self):
        """P5-V1: Instantiation, n_states == 17."""
        from cardiac_sim.ionic.paci.model import PaciModel
        model = PaciModel(device='cpu')
        assert model.n_states == 17
        assert model.name == "Paci2013"
...
class TestPaciValidation:
    ...
    def test_current_match_myokit(self):
        ...
        from cardiac_sim.ionic.paci.model import PaciModel
        from cardiac_sim.ionic.paci.parameters import V_REST, StateIndex, get_initial_state
        from cardiac_sim.ionic.paci.currents import (
            I_Na, I_CaL, I_Kr, I_Ks, I_K1, I_to, I_f,
            I_NaCa, I_NaK, I_pCa, I_bNa, I_bCa
        )
    ...
    def test_gpu_matches_cpu(self):
        ...
        model_cpu = PaciModel(device='cpu')
        ...
        model_gpu = PaciModel(device='cuda')
