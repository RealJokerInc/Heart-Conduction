# Engine V5.5 — Implementation Progress
...
> **V5.5 = fork of V5.4 (2026-05-30).** Lineage: copied from Engine_V5.4 at full parity, then
> (a) reaction divides by tissue Cm so Cm != 1.0 is correct, (b) unused internal LBM path removed.
> The phase history below (Phases 1-9) is inherited from V5.4 and describes the shared engine
> internals — do NOT re-run or alter it. Active V5.5 work is tracked against
> `Research/Active/engine_consolidation/PLAN.md`.
