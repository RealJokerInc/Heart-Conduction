"""
Paci 2013 hiPSC-CM Model Parameters

Contains:
- StateIndex: Indices into state tensor (17 states, V separate)
- PaciParameters: All model constants
...
def get_initial_state(device: torch.device = None,
    ...
    """
    Get initial ionic state tensor for Paci 2013 model (excludes V).
