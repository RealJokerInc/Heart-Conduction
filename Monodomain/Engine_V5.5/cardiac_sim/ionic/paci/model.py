"""
Paci 2013 hiPSC-CM Model Implementation

Human induced pluripotent stem cell-derived cardiomyocyte model.
...
class PaciModel(IonicModel):
    """
    Paci 2013 hiPSC-CM ionic model.
