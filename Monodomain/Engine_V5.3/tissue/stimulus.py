"""
Stimulus Definition and Handling

Provides flexible stimulus specification for monodomain simulations.
"""
...
class Stimulus:
    ...
    amplitude : float
        Stimulus amplitude (µA/µF), typically negative for depolarizing
    """
...
class StimulusProtocol:
    ...
    def get_current(
        ...
        -------
        Istim : torch.Tensor
            Stimulus current at each node (µA/µF)
        """
