...
Verkerk et al. 2019 tested GK1_critical = 3170 S/F for the TTP06 IK1
...
class MHAS13Parameters(PHAS13Parameters):
    ...
    - GK1_ttp06 = 3.170 (TTP06 IK1 at GK1_critical from Verkerk 2019)
    ...
    # Verkerk 2019 GK1_critical = 3170 S/F = 3.170 nS/pF
