...
CONTRACT = [
    ...
    Cell('S1', 'bidomain', 'bidomain', 'boundary-ncs', 'iso', 'raise',
         lambda: bidomain(_tiny(), boundary='ncs'), 'boundary', 'landed'),
    ...
    Cell('C3', 'monodomain', 'monodomain', 'ionic-phas13', 'iso', 'effect',
         lambda: _not_none(monodomain(_tiny(), ionic_model='phas13')), '', 'landed'),
    Cell('C3', 'bidomain', 'bidomain', 'ionic-mhas13', 'iso', 'effect',
         lambda: _not_none(bidomain(_tiny(), ionic_model='mhas13')), '', 'landed'),
    # --- MED: silent-degrade -> warn ----------------------------------------
    Cell('S2', 'lbm', 'lbm', 'alpha-inert', 'iso', 'warn',
         lambda: lbm(_tiny(), boundary='neumann', alpha=0.3), 'alpha', 'landed'),
    Cell('S3', 'bidomain', 'bidomain', 'sigma_ratio', 'iso', 'warn',
         _bidomain_sigma_ratio_warn, 'sigma_ratio', 'landed'),
    Cell('C4', 'lbm', 'lbm', 'lattice-override', 'aniso', 'warn',
         lambda: lbm(_tiny(D_yy=5e-4), lattice='d2q5'), 'lattice', 'landed'),
    # --- MED: exposure ------------------------------------------------------
    Cell('C5', 'lbm', 'lbm', 'weights_mode', 'iso', 'effect', _lbm_weights_mode_exposed,
         '', 'landed'),
    Cell('C6', 'monodomain', 'monodomain', 'stencil', 'iso', 'effect',
         lambda: _not_none(monodomain(_tiny(), stencil='moore8_iso')), '', 'landed'),
    Cell('S4', 'bidomain', 'bidomain', 'splitting', 'iso', 'effect',
         lambda: _not_none(bidomain(_tiny(), splitting='godunov')), '', 'landed'),
    Cell('S4', 'monodomain', 'monodomain', 'theta-mismatch', 'iso', 'raise',
         lambda: monodomain(_tiny(), theta=0.5), 'bidomain|theta', 'landed'),
    Cell('I3', 'io', 'na', 'dtype', 'float32', 'effect', _dtype_roundtrips, '', 'landed'),
