...
def make_node(
    ...
    # Post-load rest-attractor pin (Session 27, PLAN Step 3.0). load_state_dict
    # overwrites the frozen rest bias; re-pin before returning. Idempotent and
    # a no-op on scaffold-less variants.
