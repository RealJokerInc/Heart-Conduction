...
rule (Fickian k·(V_src−V_dst), one-way + zero-pad), longer Nx=320 tissue.

Layout: 2×3. Top row: k = 0.16, 0.12, 0.08. Bottom: 0.04, 0.02, 0.01.
Sample columns: (12, 32, 72, 120, 180, 240, 280) — 4× the Nx=80 reference cols.
...
Output: simulation/outputs/images/gradient_k_per_column_lat.png
"""
...
def main():
    ...
    out_path = out_dir / "gradient_k_per_column_lat.png"
