"""Per-column LAT-deviation figure for the pump-speed sweep on the ORIGINAL
short Nx=80 tissue (matching the reference long_per_column_camel_toe.png).
This is the layout where the Goldilocks camel-toe regime around max_pump=10
should be visible.

Layout: 2×3. Top row: max_pump = 30, 20, 15. Bottom: 10, 5, 2.
Sample columns: (3, 8, 18, 30, 45, 60, 70) — same x-positions as the reference.

Output: simulation/outputs/images/pump_speed_per_column_lat_nx80.png
"""
...
def main():
    ...
    # range so the shape is legible at every pump rate (fast pumps have ~±5
    # deviation while slow pumps reach ~±300).
    ...
    out_path = out_dir / "pump_speed_per_column_lat_nx80.png"
