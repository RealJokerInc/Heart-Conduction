...
rule (Fickian k·(V_src−V_dst), one-way + zero-pad), Nx=80 short tissue.
...
Convention: dev = column-mean iso − iso(y, x).
  positive  →  cell fires earlier than column average  →  AHEAD of wavefront mean
  negative  →  cell fires later                        →  BEHIND

Output: simulation/outputs/images/gradient_k_per_column_lat_nx80.png
"""
...
def main():
    ...
    out_path = out_dir / "gradient_k_per_column_lat_nx80.png"
