---
name: save-session
description: Session cleanup agent. 5 jobs — snapshot to IDEALOG, reorganize KNOWLEDGE, cross-reference IDEALOG↔KNOWLEDGE, condense IDEALOG, update MASTER_KNOWLEDGE_INDEX. Comprehensive rewrite allowed.
argument-hint: "[optional: research question name]"
---

# Save Session

Session cleanup agent. Runs five editorial jobs to keep research documents healthy.
